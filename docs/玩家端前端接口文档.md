...
- **API Base URL**: `http://localhost:21001/api/v1`
- **WebSocket URL**: `ws://localhost:21001`
...
// 5. 连接WebSocket
const socket = io('ws://localhost:21001');
...
1. **无需认证**: 玩家端所有接口都无需认证
2. **CORS配置**: 后端已配置允许 `localhost:20001` 和 `localhost:20002` 访问
